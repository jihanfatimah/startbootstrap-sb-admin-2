                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="#" class="btn btn-warning btn-icon-split mb-4" data-toggle="modal"
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-sm-12 col-md-6">
                                ...
                                <input type="text" name="id" id="id" class="form-control" placeholder="OP006" disabled="">
                                <input type="hidden" name="id" value="OP006">
                            </div>
                            <div class="form-group col-sm-12 col-md-6">
