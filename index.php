                ...
                <nav class="navbar navbar-expand topbar mb-4 fixed-top">
                    ...
                    <div class="container-fluid">
                        <a class="navbar-brand" href="#">
                             <img src="img/logo.png" alt="" width="70" height="auto" class="d-inline-block align-text-top">
                        </a>
                    </div>
                    <!-- Topbar Search -->
                    <!-- Topbar Navbar -->
                    ...
                    <div class="jumbotron bg-gradient-primary text-white">
                        <div class="row">
                            <div class="col">
                                ...
                                <hr class="my-4">
                                <p class="lead">
                                    <a class="btn btn-primary btn-lg" href="#" role="button">Ayo Laundry</a>
                                </p>
                            </div>
                            <div class="col">
                                <img class="img-fluid" src="img/banner1.svg" alt="banner1">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card mb-4 text-white">
                                <div class="card-body">
                                    ...
                                    <div class="row align-items-center justify-content-between">
                                        ...
                                        <div class="col">
                                            <img class="img-fluid" src="img/bg1.svg">
                                        </div>
                                    </div>
                            ...
                            <div class="card mb-4 text-white">
                                <div class="card-body">
                                    ...
                                    <div class="row align-items-center justify-content-between">
                                        ...
                                        <div class="col">
                                            <img class="img-fluid" src="img/bg2.svg">
                                        </div>
                                    </div>
                            ...
                            <div class="card mb-4  text-white">
                                <div class="card-body">
                                    ...
                                    <div class="row align-items-center justify-content-between">
                                        ...
                                        <div class="col">
                                            <img class="img-fluid" src="img/bg3.svg">
                                        </div>
                                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="p-5">
                            ...
                            <div class="text-center">
                                <a class="small" href="forgot-password.html">Back to Homepage</a>
                            </div>
                        </div>
                    </div>
                </div>
